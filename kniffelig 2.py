...
def rollType(diceList):
    ...
    if 5 in counts:
        ...
        if diceListNew[-2] == diceListNew[-1] - 1 and diceListNew[-3] == diceListNew[-2] - 1 and diceListNew[-4] == diceListNew[-3] - 1 and diceListNew[-5] == diceListNew[-4] - 1:
            ...
            kleine_Straße = True
            print(format("kleine Straße", '>80s'))
        elif diceListNew[0] % 2 == 0 and diceListNew[1] % 2 == 0 and diceListNew[2] % 2 == 0 and diceListNew[3] % 2 == 0 and diceListNew[4] % 2 == 0:
            gerade = True
        ...
        pass
    result = Kniffel, volles_Haus, kleine_Straße, große_Straße, Viererpasch, Dreierpasch, gerade, ungerade
    return result
